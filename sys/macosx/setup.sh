...
if [ -f sys/macosx/Makefile.top ]; then cd sys/macosx; fi
...
#
	...
	if [ $? -eq 0 ] ; then
		...
		umask 0
		ln -s sys/macosx/Makefile.top ../../Makefile
		ln -s ../sys/macosx/Makefile.dat ../../dat/Makefile
		ln -s ../sys/macosx/Makefile.doc ../../doc/Makefile
		ln -s ../sys/macosx/Makefile.src ../../src/Makefile
		ln -s ../sys/macosx/Makefile.utl ../../util/Makefile
		exit 0
	fi
fi
